...
{
	/*  
        1. Creates a file called keyfile.txt containing string "Hello world" (you may do
	...
	if(msqid == -1)
	{
		perror("msqid error from sender\n");
		exit(EXIT_FAILURE); 
	}
}
...
void cleanUp(const int& shmid, const int& msqid, void* sharedMemPtr)
{
	...
	shmdt(sharedMemPtr); 
	printf("Memory detatched from sender\n");
}
